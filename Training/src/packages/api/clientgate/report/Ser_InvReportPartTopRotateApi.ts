...
export const useSer_InvReportPartTopRotateApi = (apiBase: AxiosInstance) => {
  // apiBase.defaults.headers["DealerCode"] = "HTV";
  return {
    Ser_InvReportPartTopRotate_SearchDL: async (
      params: SerInvReportPartMinQuantity_SearchDLParam
    ): Promise<ApiResponse<any>> => {
      return await apiBase.post<
        SerInvReportPartMinQuantity_SearchDLParam,
        ApiResponse<any>
      >("/SerInvReportPartTopRotate/SearchDL", {
        ...params,
      });
    },
    Ser_InvReportPartTopRotate_ExportSearchDL: async (
      params: SerInvReportPartMinQuantity_SearchDLParam
    ): Promise<ApiResponse<any>> => {
      return await apiBase.post<
        SerInvReportPartMinQuantity_SearchDLParam,
        ApiResponse<any>
      >("/SerInvReportPartTopRotate/ExportSearchDL", {
        ...params,
      });
    },
  };
