...
export const useSer_InvReportPartMinQuantityApi = (apiBase: AxiosInstance) => {
  // apiBase.defaults.headers["DealerCode"] = "HTV";
  return {
    Rpt_SerInvReportPartMinQuantity_SearchDL: async (
      ...
      return await apiBase.post<
        ...
        ApiResponse<any>
      >("/SerInvReportPartMinQuantity/SearchDL", {
        ...params,
      });
    },
    Rpt_SerInvReportPartMinQuantity_ExportSearchDL: async (
      params: SerInvReportPartMinQuantity_SearchDLParam
    ): Promise<ApiResponse<any>> => {
      console.log(params);
      return await apiBase.post<
        SerInvReportPartMinQuantity_SearchDLParam,
        ApiResponse<any>
      >("/SerInvReportPartMinQuantity/ExportSearchDL", {
        ...params,
      });
    },
  };
