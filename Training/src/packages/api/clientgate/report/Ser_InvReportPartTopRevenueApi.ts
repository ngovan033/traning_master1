...
export const useSer_InvReportPartTopRevenueApi = (apiBase: AxiosInstance) => {
  // apiBase.defaults.headers["DealerCode"] = "HTV";
  return {
    Ser_InvReportPartTopRevenue_SearchDL: async (
      params: SerInvReportPartMinQuantity_SearchDLParam
    ): Promise<ApiResponse<any>> => {
      return await apiBase.post<
        SerInvReportPartMinQuantity_SearchDLParam,
        ApiResponse<any>
      >("/SerInvReportPartTopRevenue/SearchDL", {
        ...params,
      });
    },
    Ser_InvReportPartTopRevenue_ExportSearchDL: async (
      params: SerInvReportPartMinQuantity_SearchDLParam
    ): Promise<ApiResponse<any>> => {
      return await apiBase.post<
        SerInvReportPartMinQuantity_SearchDLParam,
        ApiResponse<any>
      >("/SerInvReportPartTopRevenue/ExportSearchDL", {
        ...params,
      });
    },
  };
