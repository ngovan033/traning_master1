...
export const useTimKiemThongTinSuaChuaApi = (apiBase: AxiosInstance) => {
  apiBase.defaults.headers["DealerCode"] = "HTV";
  return {
    TimKiemThongTinSuaChua_SearchHQ: async (params: any): Promise<any> => {
      const request = {
        ...params,
    ...
    TimKiemThongTinSuaChua_SearchDL: async (params: any): Promise<any> => {
      // fake response data
    ...
    // Get all DealerCode
    TimKiemThongTinSuaChua_GetAllActive: async (): Promise<
