    ...
    <>
      {list?.length > 1 && (
        <section className="h-full w-full">
          ...
          >
            <div className="bg-white w-[50%] h-[80%] rounded-[13px] shadow-2xl flex items-center flex-col p-[10px] gap-[10px]">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              <p className="font-extrabold text-xl text-center uppercase text-[#098850]">
